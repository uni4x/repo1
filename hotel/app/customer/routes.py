...
def customers(id):
    ...
    query = Customer.query.filter(Customer.deleted_at.is_(None))  # 論理削除されていない顧客のみを取得
    ...
    return render_template('customer.html', customers=customers, pagination=pagination, sort_order=sort_order, form=form, id=id)
