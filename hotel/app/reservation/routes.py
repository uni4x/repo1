...
def reservations(id):
    ...
    # GET リクエストの処理
    query = Reservation.query.filter(Reservation.deleted_at.is_(None))  # 論理削除されていない予約のみを取得
    ...
    return render_template('reservation.html', reservations=reservations, pagination=pagination, sort_order=sort_order, form=form, id=id)
