...
def confirmation(room_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.thank_you.thank_you', room_id=room_id, customer_id=customer.id))
    
    return render_template('confirmation.html', room=room, customer_info=customer_info, checkin_date=checkin_date, checkout_date=checkout_date, payment_type=payment_type, form=form, room_id=room_id, number_of_guests=number_of_guests)
