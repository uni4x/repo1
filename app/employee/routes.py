...
def employees(id):
    ...
    if request.method == 'POST':
        if form.validate():
            if id:
                ...
                employee.description = request.form.get('description2', employee.description)
    ...
    return render_template('employees.html', employees=employees, pagination=pagination, sort_order=sort_order, form=form, id=id)
