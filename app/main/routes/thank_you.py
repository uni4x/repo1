...
def thank_you(room_id, customer_id):
    ...
    return render_template('thank_you.html', room=room, customer=customer, checkin_date=checkin_date, checkout_date=checkout_date,  number_of_guests=number_of_guests)